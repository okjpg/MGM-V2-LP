    ...
    <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-lg border-b border-stone-100/50">
      <div className="max-w-7xl mx-auto px-4 md:px-8 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <TactileButton primary>Start Free Trial</TactileButton>
        </div>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="absolute top-20 left-0 w-full bg-white border-b border-stone-100 p-4 flex flex-col gap-4 md:hidden shadow-xl">
          <a href="#features" className="font-medium text-stone-800">Features</a>
          <a href="#analytics" className="font-medium text-stone-800">Analytics</a>
          <a href="#pricing" className="font-medium text-stone-800">Pricing</a>
          <TactileButton primary>Start Free Trial</TactileButton>
        </div>
      )}
    </nav>
...
const HeroText = () => {
  return (
    <div className="pt-40 pb-20 text-center px-4 relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-gradient-to-b from-orange-100/40 to-transparent rounded-[100%] blur-3xl -z-10" />
      ...
      >
        <motion.div 
          ...
          whileTap={{ scale: 0.95 }}
          className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-white border border-stone-200 text-stone-600 text-xs font-bold uppercase tracking-widest mb-8 shadow-sm cursor-pointer hover:border-orange-200"
        >
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-stone-900 tracking-tight mb-8 max-w-5xl mx-auto leading-[1.05]">
        ...
        <p className="text-xl md:text-2xl text-stone-500 max-w-2xl mx-auto mb-12 leading-relaxed font-light">
          MGM turns noisy chat logs into actionable intelligence. <br/>Monitor, summarize, and grow with tactile precision.
        </p>
        
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <TactileButton primary className="px-8 py-4 text-lg h-14 rounded-2xl">Start Free Trial</TactileButton>
          <TactileButton className="px-8 py-4 text-lg h-14 rounded-2xl flex items-center gap-2">
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] text-stone-900 font-sans selection:bg-orange-100 selection:text-orange-900 bg-dot-pattern">
      <Navbar />
      ...
      <main>
        ...
        <section className="py-24 px-4">
          <ScrollReveal>
            <div className="max-w-5xl mx-auto bg-stone-900 rounded-[2.5rem] p-12 md:p-24 text-center relative overflow-hidden shadow-2xl">
               ...
               <div className="relative z-10">
                 <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 tracking-tight">Ready to calm the chaos?</h2>
                 <p className="text-xl text-stone-400 mb-10 max-w-2xl mx-auto">Join thousands of community builders who use MGM to turn conversation into conversion.</p>
                 <motion.button 
                   whileHover={{ scale: 1.05 }}
                   whileTap={{ scale: 0.95 }}
                   className="bg-white text-stone-900 px-10 py-5 rounded-2xl font-bold text-lg hover:bg-stone-100 transition-colors shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)]"
                 >
                   Get Started Now
                 </motion.button>
               </div>
        ...
        <footer className="bg-white text-stone-500 py-20 border-t border-stone-200">
           <div className="max-w-7xl mx-auto px-4 md:px-8">
             ...
             <div className="pt-8 border-t border-stone-100 flex flex-col md:flex-row justify-between items-center text-sm">
               <p>&copy; 2024 MyGroupMetrics Inc. All rights reserved.</p>
