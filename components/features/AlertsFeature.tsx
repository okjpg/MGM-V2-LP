...
const AlertRow = ({ severity, title, time, active, onClick }: any) => (
  <motion.div 
    layout
    onClick={onClick}
  ...
  >
    ...
    <div className="pl-4">
      <p className="text-xs text-stone-500 line-clamp-1">Abnormal sentiment drop detected in last hour.</p>
    </div>
  </motion.div>
);
        ...
        <div className="lg:w-1/2 space-y-8">
          ...
          <ScrollReveal delay={0.1}>
             <h2 className="text-4xl md:text-5xl font-bold text-stone-900 leading-tight">
               Never miss a <span className="text-rose-500">critical beat</span>.
             </h2>
          </ScrollReveal>

          <ScrollReveal delay={0.2}>
             <p className="text-lg text-stone-600 leading-relaxed">
               MGM monitors your community 24/7. It detects urgency, sentiment drops, and operational bottlenecks, flagging them instantly so you can act before fires spread.
             </p>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.3}>
            <div className="flex gap-4 pt-2">
               <div className="flex items-center gap-2 text-stone-700 font-medium text-sm">
                 ...
                 <span>Sentiment drops</span>
               </div>
               <div className="flex items-center gap-2 text-stone-700 font-medium text-sm">
                 <CheckCircle2 size={16} className="text-rose-500" />
                 <span>Keyword spikes</span>
               </div>
               <div className="flex items-center gap-2 text-stone-700 font-medium text-sm">
                 <CheckCircle2 size={16} className="text-rose-500" />
                 <span>Mod fatigue</span>
               </div>
            </div>
             <div className="pt-6">
               <TactileButton>Configure alerts</TactileButton>
             </div>
          </ScrollReveal>
        </div>
          ...
          >
            ...
            <Card className="min-h-[400px] bg-white/50 backdrop-blur-sm border-stone-200/60 p-6 relative overflow-hidden">
               <div className="flex items-center justify-between mb-8">
                 ...
                 <div className="text-xs bg-stone-100 px-2 py-1 rounded text-stone-500">Updates realtime</div>
               </div>

               <div className="space-y-2">
                  <AlertRow title="Product Beta" time="Just now" severity="critical" active={activeTab === 0} onClick={() => setActiveTab(0)} />
                  <AlertRow title="Support VIP" time="12m ago" severity="medium" active={activeTab === 1} onClick={() => setActiveTab(1)} />
                  <AlertRow title="General Chat" time="45m ago" severity="low" active={activeTab === 2} onClick={() => setActiveTab(2)} />
               </div>
               ...
               >
                  ...
                  <p className="text-sm text-stone-700 mb-3">
                    Detected a 45% increase in negative keywords "crash", "broken", "refund" within the last 15 minutes in <strong>#product-beta</strong>.
                  </p>
