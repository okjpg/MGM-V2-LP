...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[50rem] md:h-[65rem] flex items-center justify-center relative p-2 md:p-10 overflow-hidden"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-stone-200 p-2 md:p-6 bg-white rounded-[30px] shadow-2xl"
    >
      <div className=" h-full w-full overflow-hidden rounded-2xl bg-[#FDFBF7] md:rounded-2xl md:p-4 ">
        {children}
      </div>
    </motion.div>
  );
